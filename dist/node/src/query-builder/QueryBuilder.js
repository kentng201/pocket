...
exports.QueryBuilder = exports.getNewId = void 0;
...
function getNewId() {
    return String(short_uuid_1.default.generate());
}
...
class QueryBuilder {
    constructor(model, relationships, dbName, isOne, apiInfo) {
        ...
        this.isOne = isOne;
        this.db = DatabaseManager_1.DatabaseManager.get(this.dbName);
        if (!this.db)
            throw new Error(`Database ${this.dbName} not found`);
        this.apiInfo = apiInfo;
        if (this.apiInfo)
            this.api = new ApiRepo_1.ApiRepo(this.apiInfo);
    }
    ...
    where(...args) {
        ...
        if (args.length === 3) {
            ...
            let newQuery;
            const idFields = (0, RelationshipDecorator_1.getForeignIdFields)(this.model);
                ...
                for (const r of this.relationships) {
                    try {
                        if (r.includes('.')) {
                            ...
                            if (mainModel && mainModel instanceof Model_1.BaseModel) {
    ...
    jsSearch() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            result.docs = result.docs.map((doc) => {
                ...
                if (!item.payload)
                    return item;
                const decryptedItem = (0, encryption_1.decrypt)(item.payload, this.dbName || 'default');
    ...
    update(attributes) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            delete attr.id;
            attr = (0, RelationshipDecorator_1.convertIdFieldsToDocIds)(attr, this.model);
