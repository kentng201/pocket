...
import { needToReload } from '../real-time/RealTimeModel';
...
import MultipleDatabase from '../multi-database/MultiDatabase';
import { getMainDatabaseName } from '../multi-database/MutliDatabaseConfig';
export function setDefaultDbName(dbName) {
    BaseModel.dbName = dbName;
    return BaseModel.dbName;
}
export function setDefaultNeedTimestamp(timestamp) {
    BaseModel.timestamp = timestamp;
    return BaseModel.timestamp;
}
export function setDefaultNeedSoftDelete(softDelete) {
...
class BaseModel {
     ...
     */
    static repo() {
        return RepoManager.get(new this());
    }
    /**
     ...
     */
    static first() {
        return new QueryBuilder(new this, undefined, this.dbName).first();
    }
    /**
     * Count all models
     ...
     */
    static count() {
        return new QueryBuilder(new this, undefined, this.dbName).count();
    }
    /**
     * Get all models
    ...
    static all() {
        return __awaiter(this, void 0, void 0, function* () {
            return new QueryBuilder(new this, undefined, this.dbName).get();
        });
    }
    /**
    ...
    static find(primaryKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((new this).multiDatabase) {
                const result = yield Promise.all(MultipleDatabase.databases.map((db) => __awaiter(this, void 0, void 0, function* () {
                    var _a;
                    const item = yield ((_a = DatabaseManager
            ...
            const item = yield RepoManager.get(new this()).getDoc(primaryKey);
            if (!item)
                return undefined;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            for (const field in this) {
                if (Array.isArray(this[field]) && this[field][0] instanceof BaseModel) {
                    ...
                    if ((query === null || query === void 0 ? void 0 : query.getRelationshipType()) === RelationshipType.HAS_MANY) {
                    ...
                    if ((query === null || query === void 0 ? void 0 : query.getRelationshipType()) === RelationshipType.HAS_ONE) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.id) {
                if (this.multiDatabase) {
                    hasDocumentInDb = yield MultiQueryBuilder.query(new (this.getClass())).find(this.id);
                }
                else {
            ...
            if (!hasDocumentInDb) {
                ...
                if (this.multiDatabase) {
                    ...
                    updatedResult = yield MultiQueryBuilder.query(new (this.getClass())).create(newAttributes, currentPeriod);
                ...
                if (this.multiDatabase) {
                    updatedResult = yield MultiQueryBuilder.query(new (this.getClass())).update(newAttributes, this._meta._period);
                }
                else {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.getClass().softDelete && !forceDelete) {
                ...
                if (this.multiDatabase) {
                    ...
                    yield QueryBuilder.query(this, undefined, periodDbName).setPeriod(this._meta._period).deleteOne(this.id);
                }
                else {
    ...
    static withTrashed() {
        return new QueryBuilder(new this, undefined, this.dbName).withTrashed();
    }
    static onlyTrashed() {
        return new QueryBuilder(new this, undefined, this.dbName).onlyTrashed();
    }
    static withoutTrashed() {
        return new QueryBuilder(new this, undefined, this.dbName).withoutTrashed();
    }
    restore() {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    static via(dbName) {
        return new QueryBuilder(new this, undefined, dbName);
    }
    /**
     ...
     */
    static query() {
        return new QueryBuilder(new this, undefined, this.dbName);
    }
    static where(...args) {
        const query = new QueryBuilder(new this, undefined, this.dbName);
        // @ts-ignore
    ...
    static with(...relationships) {
        const model = new this;
        return new QueryBuilder(model, relationships, this.dbName);
    }
    /**
    ...
    belongsTo(relationship, localKey, foreignKey) {
        return belongsTo(this, relationship, localKey, foreignKey);
    }
    hasOne(relationship, localKey, foreignKey) {
        return hasOne(this, relationship, localKey, foreignKey);
    }
    hasMany(relationship, localKey, foreignKey) {
        return hasMany(this, relationship, localKey, foreignKey);
    }
    belongsToMany(relationship, pivot, localKey, foreignKey) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield belongsToMany(this, relationship, pivot, localKey, foreignKey);
        });
    }
    // end of relationship
    // start api method
